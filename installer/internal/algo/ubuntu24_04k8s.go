...
func NewUbuntu24_04Installer(ctx context.Context, arch, bundleAddrs string, skipKernelModuleCleanup bool) (*Ubuntu24_04Installer, error) {
	base, err := NewBaseUbuntuInstaller(ctx, arch, bundleAddrs, systemdCgroupConfig2404, skipKernelModuleCleanup)
	if err != nil {
		return nil, err
	}
