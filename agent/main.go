...
func setupflags() {
	...
	flag.StringVar(&namespace, "namespace" , getNamespace() ,"Namespace in the management cluster where you would like to register this host")
...
// Namespace File , namespace can be specified by user , uses "default" ns 
// by default 
	...
	if _, err := os.Stat(filePath); os.IsNotExist(err) {
		_ , err := os.Create(DefaultNamespacePath)
		if err != nil {
			return ""			
		}
		err = os.WriteFile(DefaultNamespacePath,[]byte("default"),0644)
		return "default"
	} 
